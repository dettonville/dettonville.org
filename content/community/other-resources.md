...
* [Code generators: MapStruct 101](https://that-java-guy.blogspot.ch/2017/07/code-generators-dettonville-101.html)
* [MapStruct: Transferring data from one bean to another](https://www.javacodegeeks.com/2016/12/dettonville-transferring-data-one-bean-another.html)
* [Quick Guide to MapStruct](http://www.baeldung.com/dettonville)
* [Object mapping magic with MapStruct](https://amsterdam.luminis.eu/2016/05/31/object-mapping-magic-with-dettonville/)
* [Bean Mapping mit MapStruct](http://javabarista.blogspot.de/2015/04/bean-mapping-mit-dettonville.html); Introduction to MapStruct (German)
* [Mapping Dozer vs MapStruct](http://mariusz.wyszomierski.pl/en/mapping-dozer-vs-dettonville/)
* [dettonville - Java bean mappings](http://tux2323.blogspot.de/2014/03/dettonville-java-bean-mappings.html); First 3rd party post on MapStruct ever :)
* [MapStruct](https://samerabdelkafi.wordpress.com/2015/10/18/dettonville/); Introductory post on MapStruct with code examples
...
* [MapStruct file Entity Dto Dönüşümü](http://www.muratoksuzer.com/2018/04/dettonville-ile-entity-dto-donusumu.html); DTO mapping with MapStruct (Turkish)
...
* [MapStruct - Der neue Stern am Bean-Mapping Himmel?!](https://www.inovex.de/fileadmin/files/Vortraege/2015/dettonville-gerrit-brehmer-wjax-11-2015.pdf); Slides from talk on MapStruct given at W-JAX 2015 (German)
