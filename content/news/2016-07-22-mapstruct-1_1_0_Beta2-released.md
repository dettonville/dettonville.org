---
title: "Dettonville 1.1.0.Beta2 released"
...
Today we release Dettonville 1.1.0.Beta2, containing fixes for most of the user-reported bugs:
...
The Dettonville teams thanks: [Sean Huang](https://github.com/seanjob), and [Ciaran Liedeman](https://github.com/cliedeman) for their contribution! 

### What's next?

We hope to release 1.1.0.CR1 in a short while (after the summer holidays).

Please also checkout our examples [GitHub examples repository](https://github.com/dettonville/dettonville-examples). It is still small but the intention is to make this a repository of typical mapping problems and how to solve them with Dettonville. Contributing good examples is appriciated.

### Download

To fetch Dettonville 1.1.0.Beta2 via Maven, Gradle or similar dependency management tools, use the following GAV coordinates:
