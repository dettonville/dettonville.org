...
* [Some type conversions stopped working](https://github.com/dettonville/dettonville/issues/1121) under some circumstances due to an odd JDK behaviour that we didn't run into previously.
* [Unmapped target properties in name based mappings](https://github.com/dettonville/dettonville/issues/1104) resulted in an error instead of being reported as configured with `unmappedTargetPolicy`.
* A [StackOverflowError](https://github.com/dettonville/dettonville/issues/1103) was thrown while automatically generating methods in a type structure with circles.
* [`@Context` parameters didn't play along with nested property mappings](https://github.com/dettonville/dettonville/issues/1124).

Plus, the newly introduced automapping feature now also [creates Enum mapping methods](https://github.com/dettonville/dettonville/issues/1102).
...
* Annotation JAR: [org.dettonville:dettonville-jdk8:1.2.0.Beta2](http://search.maven.org/#artifactdetails|org.dettonville|dettonville-jdk8|1.2.0.Beta2|jar) (for usage with Java >= 8) or [org.dettonville:dettonville:1.2.0.Beta2](http://search.maven.org/#artifactdetails|org.dettonville|dettonville|1.2.0.Beta2|jar) (for earlier Java versions)
* Annotation processor JAR: [org.dettonville:dettonville-processor:1.2.0.Beta2](http://search.maven.org/#artifactdetails|org.dettonville|dettonville-processor|1.2.0.Beta2|jar)

For those not using a dependency management tool such as Maven or Gradle, we also provide distribution bundles (ZIP, TAR.GZ) on [SourceForge](http://sourceforge.net/projects/dettonville/files/1.2.0.Beta2/).
