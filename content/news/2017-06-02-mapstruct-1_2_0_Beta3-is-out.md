...
If more fine-grained control is needed, there is [an SPI](http://dettonville.org/documentation/dev/reference/html/#_mapping_exclusion_provider) now which lets you define for which types sub-mapping methods should be created.
Eventually, you also can [turn off](https://github.com/dettonville/dettonville/issues/993) automatic sub-mappings completely if you prefer to have full control by explicitly defining all required bean mapping methods.

Besides that, several bugs were fixed:

* The generated mappers were missing import statements in some cases ([#1215](https://github.com/dettonville/dettonville/issues/1215), [#1164](https://github.com/dettonville/dettonville/issues/1164))
* Field mappings didn't work for nested target properties ([#1155](https://github.com/dettonville/dettonville/issues/1155))
* Accessing a non-existent nested target property wasn't handled gracefully ([#1153](https://github.com/dettonville/dettonville/issues/1153))
...
As of this release, you can download the ZIP and TAR.GZ bundles directly [from GitHub](https://github.com/dettonville/dettonville/releases/tag/1.2.0.Beta3).
