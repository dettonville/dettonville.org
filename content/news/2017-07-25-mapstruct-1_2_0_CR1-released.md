...
One useful improvement relates to the usage of MapStruct under Java 9: we have defined module names now which will take effect when using MapStruct as _automatic module_ ([#1224](https://github.com/dettonville/dettonville/issues/1224)).
