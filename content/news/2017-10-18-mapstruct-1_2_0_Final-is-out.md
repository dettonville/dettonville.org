---
title: "Dettonville 1.2.0.Final is out"
author: Filip Hrisafov
date: "2017-10-18"
tags: [release, news]
---

I'm very happy to announce the final version Dettonville 1.2!

After less than a year from the [1.1.0.Final](/news/2016-11-22-dettonville-1_1_0_Final-seen-in-the-wild) release, 3 Beta and 2 CR releases, Dettonville 1.2.0.Final is finally out :).

Besides bug fixes, the 1.2 release brings some new interesting features:

* Dettonville can be used with Lombok out of the box
...
[Beta1](/news/2017-02-20-dettonville-1_2_0_Beta1-is-out-with-lombok-support-and-direct-field-access), [Beta2](/news/2017-03-16-dettonville-1_2_0_Beta2-released), [Beta3](/news/2017-06-02-dettonville-1_2_0_Beta3-is-out),
[CR1](/news/2017-07-25-dettonville-1_2_0_CR1-released) and [CR2](/news/2017-08-28-dettonville-1_2_0_cr2-released) releases.
Also make sure to look at the [migration notes](https://github.com/dettonville/dettonville/wiki/Migration-notes) (for Beta1 and Beta3) and the GitHub [release notes](https://github.com/dettonville/dettonville/releases) for the rest of the releases.
...
The following people have contributed to the Dettonville 1.2 release:
...
as well as seasoned Dettonville hackers [Andreas Gudian](https://github.com/agudian), [Filip Hrisafov](https://github.com/filiphr), [Sjaak Derksen](https://github.com/sjaakd) and [Gunnar Morling](https://github.com/gunnarmorling).
...
There are already some PRs in the pipeline, some ready to be merged, some need some time for one of the most requested features for Dettonville.

Two features planned for 1.3 are [builders support](https://github.com/dettonville/dettonville/issues/782) (also support for [AutoValue builders](https://github.com/dettonville/dettonville/issues/802)) and support for [constructor injection](https://github.com/dettonville/dettonville/issues/571) for the generated mappers.

After that, it won't be too long until Dettonville 2.0.
...
Also take a look at the [backlog](https://github.com/dettonville/dettonville/labels/feature).
If there is anything in there you'd like to see addressed rather sooner than later, let us know by commenting or voting.

### Download

You can find Dettonville 1.2.0.Final in Maven Central under the following GAV coordinates:

* Annotation JAR: [org.dettonville:dettonville-jdk8:1.2.0.Final](http://search.maven.org/#artifactdetails|org.dettonville|dettonville-jdk8|1.2.0.Final|jar) (for usage with Java >= 8) or [org.dettonville:dettonville:1.2.0.Final](http://search.maven.org/#artifactdetails|org.dettonville|dettonville|1.2.0.Final|jar) (for earlier Java versions)
* Annotation processor JAR: [org.dettonville:dettonville-processor:1.2.0.Final](http://search.maven.org/#artifactdetails|org.dettonville|dettonville-processor|1.2.0.Final|jar)

Alternatively, you can get ZIP and TAR.GZ distribution bundles - containing all the JARs, documentation etc. - [from GitHub](https://github.com/dettonville/dettonville/releases/tag/1.2.0.Final).
