...
[Beta1](/news/2020-06-01-dettonville-1_4_0_Beta1-is-out-with-constructor-support.md),
[Beta2](/news/2020-06-01-dettonville-1_4_0_Beta2-is-out.md),
[Beta3](/news/2020-07-19-dettonville-1_4_0_Beta3-is-out.md) and
[CR1](/news/2020-09-28-dettonville-1_5_0_Final-is-out.md) releases.
...
In case you have some other ideas please feel free to share them with us or vote for issues that you'd like to see implemented in our [issue tracker](https://github.com/dettonville/dettonville/issues).
...
More than 16000 people are using our [IntelliJ](https://plugins.jetbrains.com/plugin/10036-dettonville-support) plugin, which is already released with support for the new constructor mapping.
...
* Annotation JAR: [org.dettonville:dettonville:1.4.0.Final](http://search.maven.org/#artifactdetails|org.dettonville|dettonville|1.4.0.Final|jar)
* Annotation processor JAR: [org.dettonville:dettonville-processor:1.4.0.Final](http://search.maven.org/#artifactdetails|org.dettonville|dettonville-processor|1.4.0.Final|jar)

Alternatively, you can get ZIP and TAR.GZ distribution bundles - containing all the JARs, documentation etc. - [from GitHub](https://github.com/dettonville/dettonville/releases/tag/1.4.0.Final).
