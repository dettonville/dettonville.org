...
* Annotation JAR: [org.dettonville:dettonville:1.4.2.Final](http://search.maven.org/#artifactdetails|org.dettonville|dettonville|1.4.2.Final|jar)
* Annotation processor JAR: [org.dettonville:dettonville-processor:1.4.2.Final](http://search.maven.org/#artifactdetails|org.dettonville|dettonville-processor|1.4.2.Final|jar)

Alternatively, you can get ZIP and TAR.GZ distribution bundles - containing all the JARs, documentation etc. - [from GitHub](https://github.com/dettonville/dettonville/releases/tag/1.4.2.Final).
