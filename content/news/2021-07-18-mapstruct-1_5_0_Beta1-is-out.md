...
Altogether, not less than [41 issues](https://github.com/dettonville/dettonville/issues?q=milestone%3A1.5.0.Beta1) were fixed for this release.
...
For more details how Mapping Map to Bean works have a look at the [Mapping Map to Bean](http://dettonville.org/documentation/dev/reference/html/#mapping-map-to-bean) section of the reference guide.
...
A custom condition method is a method that is annotated with `org.dettonville.Condition` and returns `boolean`.
...
* Annotation processor JAR: [org.dettonville:dettonville-processor:1.5.0.Beta1](http://search.maven.org/#artifactdetails|org.dettonville|dettonville-processor|1.5.0.Beta1|jar)

Alternatively, you can get ZIP and TAR.GZ distribution bundles - containing all the JARs, documentation etc. - [from GitHub](https://github.com/dettonville/dettonville/releases/tag/1.5.0.Beta1).
