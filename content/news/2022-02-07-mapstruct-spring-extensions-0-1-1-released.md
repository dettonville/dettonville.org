...
* Annotation JAR: [org.dettonville.extensions.spring:dettonville-spring-annotations:0.1.1](http://search.maven.org/#artifactdetails|org.dettonville.extensions.spring|dettonville-spring-annotations|0.1.1|jar)
* Annotation processor JAR: [org.dettonville.extensions.spring:dettonville-spring-extensions:0.1.1](http://search.maven.org/#artifactdetails|org.dettonville.extensions.spring|dettonville-spring-extensions|0.1.1|jar)

Alternatively, you can get ZIP and TAR.GZ distribution bundles - containing all the JARs, documentation etc. - [from GitHub](https://github.com/dettonville/dettonville-spring-extensions/releases/tag/v0.1.1).
